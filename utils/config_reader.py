...
def parse_args():
    ...
    parser.add_argument('--exp-kind', default='LATENT_FNO', choices=['LATENT_FNO','FNO','CONV_LSTM','AFNO','PERSISTANCE','GNO','VIT','GFNO','GINO','GCN','CONV_FNO','FCN_LSTM','MPGNO','BENO'], help='Kind of expierment to be run.')
